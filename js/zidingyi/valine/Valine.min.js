...
var vnumElement=document.querySelector('.vnum');var vnum=vnumElement.textContent;var plnumElement=document.querySelector('#plnum');plnumElement.textContent=vnum;var pltj=document.getElementById('pltj');pltj.style.display='inline';